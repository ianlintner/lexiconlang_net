...
public static class Example05_CustomGrammar
{
    public static void Run()
    {
        var rules = new GrammarRules<object?>
        {
            { "start", new object[]
                {
                    new Weighted<string>("#prefix.capitalize# #element.capitalize# #form.capitalize#", 5),
                    new Weighted<string>("#name.capitalize#'s #element.capitalize# #form.capitalize#", 3),
                    new Weighted<string>("the #adj.capitalize# #form.capitalize#", 2)
                }
            },
...
public static class Example09_Glyphs
{
    public static void Run()
    {
        ...
        var phoneticGlyphs = FantasyCultures.Dwarvish.Glyphs;
